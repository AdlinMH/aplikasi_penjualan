...
Public Class Faktur_Pemesanan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Faktur Pemesanan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_No_Pemesanan() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedFaktur_Pemesanan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Faktur_Pemesanan = New Faktur_Pemesanan()
        rpt.Site = Me.Site
        Return rpt
    End Function
