...
Public Class Laporan_Pelanggan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Inventory.Laporan Pelanggan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedLaporan_Pelanggan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Laporan_Pelanggan = New Laporan_Pelanggan()
        rpt.Site = Me.Site
        Return rpt
    End Function
