Public Class FormBrowerPiutang

    Private m_data As DataPiutang
    ...
    Private ReadOnly _cls As ClassPiutang
    ...
    Private Sub FormBrowerPiutang_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        gvData.DataSource = _cls.GetEntities(Function(x) x.Nilai - x.Total_Bayar > 0)
        gvData.Select()
    End Sub
End Class
