...
#Region "Instance"
    ...
    Private _clsSupplier As ClassSupplier
    Private _clsBarang As ClassBarang

    Private _data As DataPembelian
    Private _dataDetail As DetailPembelian
...
#Region "Constructor"
    Public Sub New()
        ...
        _clsSupplier = New ClassSupplier(_db)
        _clsBarang = New ClassBarang(_db)
        _bs = New BindingSource()

        _data = New DataPembelian()
        _data.DetailPembelian = New List(Of DetailPembelian)
        tbKode.Text = _cls.GetNextKode()
        gvData.AutoGenerateColumns = False
    End Sub

    Public Sub New(entity As DataPembelian)
        InitializeComponent()
        InitStatus("ubah")
        _db = New DbEntities()
        _cls = New ClassPembelian(_db)
...
#Region "Events"
    Private Sub FormPembelian_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        _bs.DataSource = _data.DetailPembelian
    ...
    Private Sub btnUbah_Click(sender As Object, e As EventArgs) Handles btnUbah.Click
        ...
        _dataDetail = _data.DetailPembelian.ElementAt(_idx)
    ...
    Private Sub btnHapus_Click(sender As Object, e As EventArgs) Handles btnHapus.Click
        ...
        _data.DetailPembelian.Remove(_dataDetail)
        _bs.ResetBindings(False)
        Dim subTotal = _data.DetailPembelian.Sum(Function(x) x.Sub_Total)
        tbSubTotal.Text = subTotal
        InitControlDetail()
    End Sub

    Private Sub btnSupplier_Click(sender As Object, e As EventArgs) Handles btnSupplier.Click
        Dim frm = New FormBrowerSupplier(_db)
        frm.ShowDialog()

        If (frm.DialogResult = DialogResult.OK) Then
            _data.DataSupplier = frm.Entity
            tbSupplier.Text = _data.DataSupplier.Kode_Supplier
            tbNamaSupplier.Text = _data.DataSupplier.Nama_Supplier
            rtbAlamat.Text = _data.DataSupplier.Alamat
        End If
    End Sub
    ...
    Private Sub btnBarang_Click(sender As Object, e As EventArgs) Handles btnBarang.Click
        ...
        If (frm.DialogResult = DialogResult.OK) Then
            _dataDetail = New DetailPembelian()
    ...
    Private Sub btnSimpanDetail_Click(sender As Object, e As EventArgs) Handles btnSimpanDetail.Click
        ...
        If ValidatingDetail() Then
            ...
            tbSubTotal.Text = _data.DetailPembelian.Sum(Function(x) x.Sub_Total)
    ...
    Private Sub btnPrint_Click(sender As Object, e As EventArgs) Handles btnPrint.Click
        ...
        rpt.SetDataSource(_data.DetailPembelian.ToList())
        rpt.SetParameterValue("Nama Supplier", tbNamaSupplier.Text)
    ...
    Private Sub tbSupplier_Validating(sender As Object, e As System.ComponentModel.CancelEventArgs) Handles tbSupplier.Validating
        If (String.IsNullOrWhiteSpace(tbSupplier.Text)) Then
            e.Cancel = True
            errMessage.SetError(tbSupplier, "Field tidak boleh kosong")
        Else
            errMessage.SetError(tbSupplier, "")
        End If
...
#Region "Methods"
    ...
    Private Sub ViewToModel()
        _data.No_Pembelian = tbKode.Text
        _data.Kode_Supplier = tbSupplier.Text
    ...
    Private Sub ModelToView()
        tbKode.Text = _data.No_Pembelian
        ...
        If (_data.DataSupplier Is Nothing) Then
            tbSupplier.Text = ""
            tbNamaSupplier.Text = ""
            rtbAlamat.Text = ""
        Else
    ...
    Private Sub ModelToView(entity As DetailPembelian)
    ...
    Private Sub ViewToModel(entity As DetailPembelian)
        entity.Kode_Barang = tbBarang.Text
        entity.Nama_Barang = tbNamaBarang.Text
        entity.No_Pembelian = tbKode.Text
