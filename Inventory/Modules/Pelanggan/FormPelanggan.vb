...
#Region "Instance"
    ...
    Private _cls As ClassPelanggan
...
#Region "Methods"
    ...
    Private Sub ViewToModel()
        _data.Kode_Pelanggan = tbKode.Text
        _data.Nama_Pelanggan = tbNama.Text
    ...
    Private Sub ModelToView()
        tbKode.Text = _data.Kode_Pelanggan
        tbNama.Text = _data.Nama_Pelanggan
